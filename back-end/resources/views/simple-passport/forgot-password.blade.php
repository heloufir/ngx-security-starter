...
<head>
    ...
    <title>@lang('simple-passport::forgot-password.title')</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
<center style="width: 100%; background-color: #f5f5f5;">
    ...
    <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
        @lang('simple-passport::forgot-password.notification_description')
    </div>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                            <h1 style="margin: 0 0 10px; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;">@lang('simple-passport::forgot-password.title')</h1>
                            <p style="margin: 0 0 10px;">@lang('simple-passport::forgot-password.description')</p>
                        </td>
                    </tr>
                    <tr>
